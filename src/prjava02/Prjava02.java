/* * To change this template, choose Tools | Templates * and open the template in the editor. */ package prjava02;
...
public class Prjava02 {
    ...
    public static void main(String[] args) {
        ...
        try {
			...
			//Conflicte solucionat afegint una nova línia des de branca01
